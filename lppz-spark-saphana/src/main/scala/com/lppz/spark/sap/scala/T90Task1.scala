...
object T90Task1 extends Serializable{
  @transient lazy val LOG=Logger.getLogger(getClass.getName) 
  
  
  def main(args : Array[String])  = {
  
      val sc = new MysqlSpark().buildSc("T90Task1", args(1))
      ...
      */
      ...
      val sql =
               ...
               val hc = HiveContextUtil.registerTmpTable(sc, sql.format(threemonthago,timestr), "t_90_qudao")
      ...
      val sql1 =
               ...
               HiveContextUtil.registerTmpTable(hc, sql1.format(threemonthago,timestr), "t_90_kouwei")
      ...
      HiveContextUtil.registerTmpTable(hc, sql2.format(threemonthago,timestr), "t_90_pinlei")
      ...
      HiveContextUtil.registerTmpTable(hc, sql3.format(threemonthago,timestr), "t_90_danpin")
      ...
      val sql4 =
               ...
               HiveContextUtil.registerTmpTable(hc, sql4.format(threemonthago,timestr,threemonthago,timestr,threemonthago,timestr,threemonthago,timestr), "t_90_riqi")
      ...
      val sql5 =                                                                                                                                                                   
               ...
               HiveContextUtil.registerTmpTable(hc, sql5.format(threemonthago,timestr,threemonthago,timestr), "t_90_goumai")
