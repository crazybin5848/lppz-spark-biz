...
public class GenerateAllOrderSparkTable {
	...
	public static void main(String[] args) throws Exception {
		 args = new String[] { "/home/licheng/workspace_spark/lppz-spark-biz/lppz-spark-exportomshistory/src/main/resources/META-INF/multimysql2hive.yaml", "local[8]",
		 "month,;2015-09,;maxdate,;'2015-09',;mindate,;'2015-07'" };
		if (args.length == 0)
